...
def sample_docs_en() -> list[Document]:
    return [
        ...
        Document(page_content="BGE-M3 supports more than 100 languages.", metadata={"source": "en.txt"}),
...
def sample_docs_ru() -> list[Document]:
    return [
        ...
        Document(page_content="BGE-M3 поддерживает более 100 языков.", metadata={"source": "ru.txt"}),
